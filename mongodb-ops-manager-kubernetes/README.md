...
|-----------|---------|---------------|
| MongoDB Controllers for Kubernetes (MCK) | 1.8.0 | [Docs](https://www.mongodb.com/docs/kubernetes/current/) |
| Ops Manager | 8.0.21 | [Release Notes](https://www.mongodb.com/docs/ops-manager/current/release-notes/application/) |
