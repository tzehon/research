#!/usr/bin/env python3
"""Run the NOC Copilot agentic demo from the terminal."""
...
from noc_copilot.db.collections import ALARMS, INCIDENTS, NETWORK_INVENTORY, RUNBOOKS
...
async def main_async() -> None:
    console.print("[bold cyan]NOC Copilot — Agentic Workflow Demo[/bold cyan]\n")
